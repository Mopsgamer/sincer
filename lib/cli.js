...
import { cfg, Exception, Manager, throwFail, version } from "./index.js";
import { existsSync } from "fs";
import chalk from "chalk";

const sincer = new Manager();
if (!existsSync(cfg.path)) sincer.reset();
throwFail(cfg.failLoad());
...
program.command("restart")
  ...
  .action(function(name) {
    wrap(() => sincer.change(name, { date: new Date() }));
  });
