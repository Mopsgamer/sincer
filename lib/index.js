...
export class Manager {
	...
	findRecordIndex(records, pattern) {
		...
		return records.findIndex((record) => this.recordMatch(pattern.toLowerCase(), record.name.toLowerCase()));
	}
	findRecord(records, pattern) {
		...
		return records.find((record) => this.recordMatch(pattern.toLowerCase(), record.name.toLowerCase()));
	}
	findRecordAll(records, pattern) {
		...
		return records.filter((record) => this.recordMatch(pattern.toLowerCase(), record.name.toLowerCase()));
	}
